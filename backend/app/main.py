...
from app.modules.post_validation.router import router as post_validation_router
...
app.include_router(post_validation_router, prefix="/api/post-validation", tags=["post-validation"])
